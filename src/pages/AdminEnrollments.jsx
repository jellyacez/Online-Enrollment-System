...
export default function AdminEnrollments() {
  ...
  // Helper function to assign the correct badge color class based on status
        ...
        {loading ? (
          ...
          <div className="table-card">
            <table className="enrollment-table">
              ...
              <tbody>
                {enrollments.map((req) => (
                  <tr key={req.id} className="animated-row">
                    <td>
                      <strong>{req.student_name}</strong>
                      <br />
                      <small>{req.student_email}</small>
                    </td>
                    <td>
                      {req.subject_code}
                      <br />
                      <small>{req.subject_description}</small>
                    </td>
                    ...
                    <td>
                      ...
                      <span
                        className={`status-badge ${getBadgeClass(req.status)}`}
                      >
                        {req.status}
                      </span>
                    </td>
